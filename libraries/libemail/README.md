...
* `_TEMPLATE_TEXT_FILE`
  Override the built-in template (default) with the contents of the `Go` text template file whose path is defined in this parameter. This takes precedence over `_TEMPLATE_TEXT` & `_FORMAT`.
