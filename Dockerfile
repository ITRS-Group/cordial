...
ARG MERMAID=".mermaid"
ARG READMEDIRS="tools/geneos tools/gateway-reporter tools/dv2email integrations/servicenow integrations/pagerduty libraries/libemail libraries/libalert"
RUN set -eux; \
