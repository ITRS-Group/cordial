...
COPY --from=build /app/cordial/integrations/servicenow/servicenow.example.yaml /app/cordial/integrations/pagerduty/pagerduty.defaults.yaml /cordial/etc/geneos/
